...
public final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        Camera.Size size = scan.getScanHelper().getCameraManager().getPreviewSize();
        ...
        Rect cropRect = scan.getCropRect();
        if (null == cropRect) {
            scan.initCropRect();
        }
        cropRect = scan.getCropRect();
        mDecodeUtils.setDataMode(scan.getScanHelper().getDataMode());
        ...
        Handler handler = scan.getScanHelper().getHandler();
